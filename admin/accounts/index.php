	...
	<div class="card-body">
        <div class="container-fluid">
			<table class="table table-bordered table-stripped" id="indi-list">
				...
				<thead>
					<tr style="background-color:blue;color:white;font-family:arial; ">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT *,concat(firstname,'  ', middlename,' ',lastname) as `name` from `accounts` order by concat(lastname,', ',firstname, middlename) desc ");
					...
					?>
						...
						<tr >
							...
							<td class='text-right' style="color:red;font-size:18px;"><?php echo number_format($row['balance'],2) ?></td>

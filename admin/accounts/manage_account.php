        ...
        <div class="container-fluid">
            <form id="account-form">
                ...
                <div class="form-group">
                    <label class="control-label">Account Number &nbsp;<sup style="color:red;">*</sup></label>
                ...
                <hr>
                <div class="form-group">
                    <label class="control-label"> Enter Account Number (Re-Enter) &nbsp;<sup style="color:red;">*</sup></label>
                    <input type="number" class="form-control col-sm-6" name="email" value="<?php echo isset($email)? $email : '' ?>" required>
                </div>
                ...
                <?php if(!isset($id)): ?>
                    <div class="form-group">
                        <label class="control-label">PIN &nbsp;<sup style="color:red;">*</sup></label>
